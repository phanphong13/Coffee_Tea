                                        ...
                                        <form action="" method="post" id="register-form">
                                            ...
                                            <div class="auth-form__form">
                                                ...
                                                <div class="auth-form__group">
                                                    ...
                                                    <input type="password" name="password" rules="required|min:6" autocomplete="on" class="auth-form__input" placeholder="Nhập mật khẩu của bạn">
                                                    <span class="auth-form__error"></span>
                                                </div>
                                                <div class="auth-form__group">
                                                    <label for="" class="auth-form__title">Nhập lại mật khẩu</label>
                                                    <input type="password" name="passwordX2" rules="isConfirm" autocomplete="on" class="auth-form__input" placeholder="Nhập lại mật khẩu của bạn">
                                                    <span class="auth-form__error"></span>
                                                </div>
                                            </div>
